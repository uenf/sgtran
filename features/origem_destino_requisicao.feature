...
#    E o local de destino da requisição com id "15" deve ser "Macaé" do "RJ"
#    E o local de origem da requisição com id "17" deve ser "Macaé" do "RJ"
#    E o local de destino da requisição com id "17" deve ser "Campos dos Goytacazes" do "RJ"
#    E eu devo ver "Requisição 15: Campos dos Goytacazes - Macaé"
#    E eu devo ver "Requisição 17: Macaé - Campos dos Goytacazes"
...
#    E que eu tenho a cidade "Campos dos Goytacazes" do "RJ"
#    E que eu tenho a cidade "Macaé" do "RJ"
#    E que eu tenho a cidade "Guarapari" do "ES"
...
#    E eu seleciono "Campos dos Goytacazes" em "cidade_origem[15]"
#    E eu seleciono "ES" em "estado_destino[15]"
#    E eu seleciono "Guarapari" em "cidade_destino[15]"

#    E eu seleciono "RJ" em "estado_origem[17]"
#    E eu seleciono "Campos dos Goytacazes" em "cidade_origem[17]"
#    E eu seleciono "RJ" em "estado_destino[17]"
#    E eu seleciono "Macaé" em "cidade_destino[17]"
...
#    E o local de destino da requisição com id "15" deve ser "Guarapari" do "ES"
#    E o local de origem da requisição com id "17" deve ser "Campos dos Goytacazes" do "RJ"
#    E o local de destino da requisição com id "17" deve ser "Macaé" do "RJ"
#    E eu devo ver "Requisição 15: Campos dos Goytacazes - Guarapari"
#    E eu devo ver "Requisição 17: Campos dos Goytacazes - Macaé"
