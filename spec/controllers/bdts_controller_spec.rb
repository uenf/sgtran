...
describe BdtsController do
  ...
  describe "GET new" do
    it "assigns a new bdt as @bdt" do
        Viagem.should_receive(:find).with("37").and_return(mock_viagem(:motorista_id => nil, :veiculo_id => nil))
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created bdt as @bdt" do
        ...
        post :create, :bdt => {:these => 'params'}, :veiculo => {}, :motorista => {}, :viagem_id => nil
        assigns[:bdt].should equal(mock_bdt)
      end
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested bdt" do
        ...
        put :update, :id => "37", :bdt => {"these" => "params"}, :veiculo => {}, :motorista => {}, :viagem_id => nil
      end

      it "assigns the requested bdt as @bdt" do
        Bdt.stub(:find).and_return(mock_bdt(:atualizar => true))
        put :update, :id => "1", :veiculo => { :id => nil }, :motorista => { :id => nil }, :viagem_id => nil
        assigns[:bdt].should equal(mock_bdt)
      end
